  ...
  const doSubmit = () => {
    ...
    emailjs
      ...
      .then(function () {
        ...
        setSubmitting(false);
        setSent(true);
        setForm({ name: '', company: '', phone: '', email: '', cat: '', vol: '', msg: '' });
        setTimeout(function () {
          setSent(false);
        }, 5000);
      })
    ...
    <div className="page-section pg active" id="page-distribute">
      ...
      <section className="sec" style={{ background: '#fff' }}><div className="sec-in"><div className="dg">
        <div className="r">
          ...
          <div className="ccrd"><div className="ccrd-ico"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.18h3a2 2 0 0 1 2 1.72 12.05 12.05 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L7.91 8.7a16 16 0 0 0 8 8l.9-.9a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 18z" /></svg></div><div><div className="cclbl">Phone &amp; WhatsApp</div><div className="ccval">+91 93193 15523</div><div className="ccsub">Mon–Sat, 9 AM – 7 PM IST</div></div></div>
          <div className="ccrd"><div className="ccrd-ico"><svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg></div><div><div className="cclbl">Email</div><div className="ccval">care@shubhlabh.ltd</div><div className="ccsub">Business &amp; partnership enquiries</div></div></div>
