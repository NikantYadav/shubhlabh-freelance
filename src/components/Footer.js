      ...
      <div className="ft-main">
        <div className="ft2-brand">
          ...
          <div className="ft2-info">
            <a href="mailto:care@shubhlabh.ltd" className="ft2-info-row"><svg className="ft2-info-ico" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z M22 6l-10 7L2 6" /></svg><span>care@shubhlabh.ltd</span></a>
